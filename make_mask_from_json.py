...
# Load the JSON data
json_file_path = r'train\_annotations.coco.json'  # Change this to your JSON file path
images_folder = r'train'                          # Path where your images are stored
masks_folder = r'Karachi_new\masks'                   # Path to save the generated masks
